...
# -*- coding: utf-8 -*-
#
# drslib documentation build configuration file, created by
...
extensions = ['sphinx.ext.autodoc', 
              # viewcode not working at present
              #'sphinx.ext.viewcode'
              ]
...
html_theme = 'esgf-sphinx-theme'

# Theme options are theme-specific and customize the look and feel of a theme
# further.  For a list of options available for each theme, see the
# documentation.
html_theme_options = {'esgf_project': 'drslib'}
