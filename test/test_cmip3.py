...
def test_1():
    ...
    p2 = convert(p)
    assert p2 == 'cmip5/output/GFDL/CM2/20c3m/day/atmos/v1/rsus/r1/rsus_A2_CM2_20c3m_r1_19610101-19651231.nc'
...
def test_var_underscore():
    ...
    assert p2 == 'cmip5/output/IPSL/CM4/1pctto2x/mon/atmos/v1/rlftoaa_co2/r1/rlftoaa_co2_A5_CM4_1pctto2x_r1_1860-1869.nc'
